...
const problems = [
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M3 5.5A1.5 1.5 0 014.5 4h2a1.5 1.5 0 011.5 1.5v1a1.5 1.5 0 01-.96 1.4L5.75 8.5a8.5 8.5 0 003.75 3.75l.6-1.29A1.5 1.5 0 0111.5 10h1A1.5 1.5 0 0114 11.5v2A1.5 1.5 0 0112.5 15C7.25 15 3 10.75 3 5.5z" stroke="#EF4444" strokeWidth="1.2" strokeLinecap="round"/>
        <path d="M14 4l-3 3M17 4l-3 3" stroke="#EF4444" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
    title: 'Missed Calls',
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <circle cx="10" cy="10" r="7" stroke="#F59E0B" strokeWidth="1.2"/>
        <path d="M10 6v4l2.5 2.5" stroke="#F59E0B" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M10 3a7 7 0 100 14A7 7 0 0010 3z" stroke="#EF4444" strokeWidth="1.2"/>
        <path d="M10 7v1M10 12v1" stroke="#EF4444" strokeWidth="1.2" strokeLinecap="round"/>
        <path d="M7 10h6" stroke="#EF4444" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
    title: 'Staff Burnout',
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M4 4h12a1 1 0 011 1v8a1 1 0 01-1 1H6l-3 3V5a1 1 0 011-1z" stroke="#F59E0B" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M8 8h4M8 11h2" stroke="#F59E0B" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <rect x="3" y="4" width="14" height="13" rx="2" stroke="#EF4444" strokeWidth="1.2"/>
        <path d="M7 4V2M13 4V2M3 8h14" stroke="#EF4444" strokeWidth="1.2" strokeLinecap="round"/>
        <path d="M7 12h2M11 12h2M7 15h2" stroke="#EF4444" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M10 3v4M10 13v4M3 10h4M13 10h4" stroke="#F59E0B" strokeWidth="1.2" strokeLinecap="round"/>
        <circle cx="10" cy="10" r="3" stroke="#F59E0B" strokeWidth="1.2"/>
      </svg>
    ),
  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 bg-white relative" id="use-cases">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1920&q=60&auto=format&fit=crop"
          alt=""
          className="w-full h-full object-cover object-center opacity-[0.04]"
        />
        {/* Subtle red/amber tinted perspective grid */}
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px]" style={{ background: 'radial-gradient(ellipse, rgba(239,68,68,0.06) 0%, transparent 70%)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#FECACA] bg-[#FEF2F2] mb-6">
              <span className="text-[10px] uppercase tracking-[0.2em] font-semibold text-[#EF4444]">The Problem</span>
            </div>
          </motion.div>
          <motion.h2
          ...
          {problems.map((problem, i) => (
            ...
            >
              ...
              >
                {/* Double-bezel light */}
                <div
                  className="p-1.5 rounded-[2rem] bg-[#0F172A]/[0.04] ring-1 ring-[#0F172A]/[0.06] h-full transition-all duration-700"
                  style={{
                    boxShadow: hoveredIndex === i
                      ? `0 0 0 1px ${problem.accentColor}30, 0 8px 40px ${problem.accentColor}12`
                      : undefined,
                  }}
                >
                  <div
                    className="rounded-[calc(2rem-6px)] bg-white p-6 h-full shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),0_1px_3px_rgba(15,23,42,0.06)] shimmer-card relative"
                    style={{ borderTop: `2px solid ${problem.tintBorder}` }}
                  >
                    {/* Colored top glow */}
                    <div
                      className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-[2px] pointer-events-none"
                      style={{
                        background: `radial-gradient(ellipse, ${problem.accentColor}40 0%, transparent 70%)`,
                        filter: 'blur(4px)',
                        top: '-1px',
                      }}
                    />
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${problem.tintBorder}`,
