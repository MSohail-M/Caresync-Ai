...
const features = [
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M4 5.5A1.5 1.5 0 015.5 4h2A1.5 1.5 0 019 5.5v1A1.5 1.5 0 018.04 7.9L6.75 8.5a9.5 9.5 0 004.75 4.75l.6-1.29A1.5 1.5 0 0113.5 11h1A1.5 1.5 0 0116 12.5v2A1.5 1.5 0 0114.5 16C8.701 16 4 11.299 4 5.5z" stroke="#22C55E" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M4 11h14M11 4l7 7-7 7" stroke="#22C55E" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M4 11h14M4 11l5-5M4 11l5 5" stroke="#22C55E" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <circle cx="11" cy="8" r="4" stroke="#22C55E" strokeWidth="1.2"/>
        <path d="M3 19c0-4 3.582-7 8-7s8 3 8 7" stroke="#22C55E" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M11 3a8 8 0 100 16A8 8 0 0011 3z" stroke="#22C55E" strokeWidth="1.2"/>
        <path d="M11 7v4l3 2" stroke="#22C55E" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M4 6h14M4 10h10M4 14h6" stroke="#22C55E" strokeWidth="1.2" strokeLinecap="round"/>
        <circle cx="17" cy="15" r="3" stroke="#22C55E" strokeWidth="1.2"/>
        <path d="M15.5 15l1 1 2-2" stroke="#22C55E" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
...
export default function Solution() {
  ...
  return (
    <section className="py-24 md:py-32 relative" id="solution" style={{ background: '#F0FDF4' }}>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 right-0 w-[500px] h-[500px] -translate-y-1/2" style={{ background: 'radial-gradient(circle, rgba(34,197,94,0.06) 0%, transparent 70%)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#86EFAC] bg-[#F0FDF4] mb-6">
              <span className="text-[10px] uppercase tracking-[0.2em] font-semibold text-[#22C55E]">The Solution</span>
            </div>
          </motion.div>
          <motion.h2
          ...
          >
            Your AI Front Desk —{' '}
            <span className="font-serif italic text-[#22C55E]">Always On, Always Professional</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Vocryn AI handles the full patient communication lifecycle so your staff can focus on care.
          </motion.p>
        </div>
        ...
        {mainFeature && (
          ...
          >
            <TiltCard intensity={8} glowColor="rgba(16,185,129,0.12)" className="w-full">
              <div className="p-1.5 rounded-[2rem] bg-[#0F172A]/[0.04] ring-1 ring-[#0F172A]/[0.06] group hover:ring-[#16A34A]/30 transition-all duration-700">
                <div
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="px-2 py-0.5 rounded-full bg-[#F0FDF4] border border-[#BBF7D0] text-[10px] font-semibold text-[#16A34A] uppercase tracking-wide">Core Feature</span>
                        </div>
                      ...
                      <div className="shrink-0 p-3 rounded-2xl bg-white/80 border border-[#BBF7D0] shadow-sm min-w-[160px]">
                        <div className="text-[9px] text-[#16A34A] uppercase tracking-wider font-semibold mb-2">Live Booking</div>
                        {['9:00 AM', '10:30 AM', '2:00 PM'].map((time, i) => (
                          ...
                          >
                            ...
                            {i === 1 && (
                              <span className="ml-auto text-[9px] text-[#16A34A] font-bold bg-[#F0FDF4] px-1.5 py-0.5 rounded-full">Booked</span>
                            )}
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#F0FDF4] border border-[#BBF7D0]">
                        ...
                        <span className="text-xs text-[#16A34A] font-medium">Always active</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {smallFeatures.map((feature, i) => (
            ...
            >
              <TiltCard intensity={15} glowColor="rgba(34,197,94,0.12)" className="h-full">
                <div className="p-1.5 rounded-[1.75rem] bg-[#0F172A]/[0.04] ring-1 ring-[#0F172A]/[0.06] h-full transition-all duration-700 hover:ring-[#22C55E]/25">
                  <div className="rounded-[calc(1.75rem-6px)] bg-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),0_1px_3px_rgba(15,23,42,0.06)] p-5 h-full shimmer-card">
                    <div className="w-10 h-10 rounded-2xl bg-[#F0FDF4] border border-[#86EFAC] flex items-center justify-center mb-4">
                      {feature.icon}
                    </div>
