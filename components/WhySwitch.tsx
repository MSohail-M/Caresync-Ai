...
const benefits = [
  {
    ...
    desc: 'Vocryn AI answers every patient call in under 2 seconds — warm, natural, and clinic-trained. No queues, no missed calls, no frustrated patients.',
    stat: '< 2s',
  ...
  },
  {
    ...
    desc: 'Clinics using Vocryn AI report measurable results — higher patient satisfaction, fewer dropped calls, and up to 50% fewer no-shows and cancellations.',
    stat: '97%',
