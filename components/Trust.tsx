        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-14">
          ...
          >
            ...
            <p className="text-[16px] text-[#64748B] leading-relaxed max-w-lg">
              Every architectural decision in Vocryn AI starts with one question: <em>how do we protect patient data?</em> Here's how we answer it.
            </p>
          </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[12px] text-amber-700/85 leading-relaxed">
                  Vocryn AI is designed with HIPAA-aware workflows — secure data handling, role-based access, and minimum necessary disclosure at every touchpoint. We do not claim formal HIPAA certification.
                </p>
              </div>
            </div>
          </motion.div>
