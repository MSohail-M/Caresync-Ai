...
const faqs = [
  {
    q: 'What are the operating hours of CareSync AI?',
    a: 'CareSync AI is available 24 hours a day, 7 days a week, 365 days a year — including weekends, holidays, and after hours. Every patient call is answered instantly, no matter when they call.',
  },
  {
    q: "What happens when CareSync AI doesn't know the answer?",
    a: 'CareSync AI is trained on your clinic\'s specific protocols and FAQs. For anything outside its knowledge — clinical questions, complaints, or emergencies — it escalates immediately to the appropriate staff member or on-call provider in under 2 seconds. No dead ends, ever.',
  },
  {
    q: 'Can CareSync AI support different languages like Spanish, Mandarin, and others?',
    a: 'Yes. CareSync AI currently supports more than 20 popular languages and accents. We can also configure support for any additional language or regional accent to match your patient population.',
  },
  {
    q: 'Can we customize the workflows to suit our practice needs?',
    a: 'Absolutely. CareSync AI is built around your clinic\'s specific workflows — appointment types, provider schedules, insurance rules, recall protocols, and more. Our onboarding team configures everything before go-live, and you can update workflows at any time.',
  },
  {
  ...
  },
  {
    ...
    a: 'No, recorded calls are not required to get started. CareSync AI can be configured and go live using your practice protocols, scheduling rules, and intake forms. Existing call recordings are helpful for fine-tuning but never a prerequisite.',
  },
  {
    q: 'Does CareSync AI provide medical advice?',
    a: 'No. CareSync AI handles administrative tasks — scheduling, eligibility, FAQs, refill routing, recalls, and more. For any clinical question or urgent medical concern, it immediately transfers the patient to a qualified staff member or provider.',
  },
  {
