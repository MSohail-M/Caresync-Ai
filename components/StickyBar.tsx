      ...
      {visible && !dismissed && (
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 8px 40px rgba(0,0,0,0.55), 0 0 0 1px rgba(13,148,136,0.12), inset 0 1px 0 rgba(255,255,255,0.05)',
          }}
        >
          {/* Avatars */}
          ...
          <a
            ...
            style={{
              ...
              boxShadow: '0 0 16px rgba(13,148,136,0.3), inset 0 1px 0 rgba(255,255,255,0.1)',
            }}
          >
            Book a Demo
          ...
          <button
            ...
            aria-label="Dismiss"
            className="w-6 h-6 rounded-full flex items-center justify-center text-[#94A3B8] hover:text-white/55 transition-colors shrink-0"
          >
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
