  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 flex flex-col" style={{ zIndex: 10 }}>
        <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center min-h-[calc(100dvh-160px)] pb-16 lg:pb-0">
            ...
            <motion.div style={{ y: textY }} className="flex flex-col justify-center pt-8 md:pt-0">
              ...
              >
                Your Clinic&apos;s<br />
                <span className="font-serif italic text-gradient-blue">HIPAA-Ready</span> AI<br />
                Receptionist.{' '}
                <span className="block text-4xl sm:text-5xl lg:text-[52px] xl:text-[58px] font-semibold text-[#475569] mt-2 leading-snug tracking-tight">
                  Every Patient Heard.<br className="hidden sm:block" /> Every Appointment Booked.
                </span>
              </motion.h1>
