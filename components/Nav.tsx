        ...
        >
          ...
          <div className="hidden md:flex items-center gap-2 ml-2">
            ...
            {!isChatbot && (
              <a
                href="#demo"
                className="flex items-center gap-2 pl-4 pr-2 py-2 rounded-full bg-[#3B8EF0] hover:bg-[#2d7de0] text-white text-sm font-semibold transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group active:scale-[0.98] shadow-[0_2px_16px_rgba(59,142,240,0.45)]"
              >
                Book a Demo
          ...
          >
            ...
            {!isChatbot && (
              <motion.a
                ...
                className="mt-2 flex items-center gap-2 px-6 py-3 rounded-full bg-[#3B8EF0] text-white text-lg font-semibold shadow-[0_4px_24px_rgba(59,142,240,0.4)]"
              >
                Book a Demo
