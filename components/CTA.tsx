          ...
          <TiltCard intensity={4} glowColor="rgba(34,197,94,0.10)" className="w-full">
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-3 px-4 py-3 rounded-2xl bg-white/[0.06] border border-white/[0.08] mb-8"
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs font-semibold text-[#F8FAFC]">Join 500+ Clinics</div>
                  <div className="text-[10px] text-[rgba(248,250,252,0.5)]">Already using CareSync AI</div>
                </div>
              </motion.div>
